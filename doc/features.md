...
!!! tip
	You can find an [example workflow for GitHub Actions](https://git.belin.io/cedx/coveralls.js/src/branch/master/.github/workflows/build.yaml) in the sources of this project.
