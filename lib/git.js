...
export class GitCommit {
   ...
   * @param {Object<string, *>} map A JSON map representing a Git commit.
...
export class GitData {
   ...
   * @param {Object<string, *>} map A JSON map representing a Git data.
...
export class GitRemote {
   ...
   * @param {Object<string, *>} map A JSON map representing a remote repository.
