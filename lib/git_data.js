...
exports.GitData = class GitData {
   ...
   */
  static fromJson(map) {
    return !map || typeof map != 'object' ? null : new GitData(GitCommit.fromJson(map.head), {
  ...
  static async fromRepository(path = process.cwd()) {
    ...
    return new GitData(GitCommit.fromJson(commands), {branch: commands.branch, remotes: Object.values(remotes)});
  }
