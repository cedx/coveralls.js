...
/**
 * Defines the options of a {@link Job} instance.
 * @typedef {object} JobOptions
 * @property {string} [repoToken] The secret token for the repository.
 * @property {string} [serviceJobId] The unique identifier of the job on the CI service.
 * @property {string} [serviceName] The CI service or other environment in which the test suite was run.
 * @property {SourceFile[]} [sourceFiles] The list of source files.
 */
...
export class Job {
  ...
  /**
   * Creates a new job.
   * @param {JobOptions} [options] An object specifying values used to initialize this instance.
   */
  constructor(options = {}) {
   ...
   * @param {Object<string, *>} map A JSON map representing a job.
   * @return {Job} The instance corresponding to the specified JSON map.
   */
  static fromJson(map) {
    const job = new Job({
